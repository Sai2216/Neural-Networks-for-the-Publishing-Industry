...
if r == 'Home':
    ...
    image = Image.open(r"C:\Users\admin\OneDrive\Desktop\GuviCapstone\finalproject\BookStore.png")  

elif r == 'Customer Churn Prediction':
    image = Image.open(r"C:\Users\admin\OneDrive\Desktop\GuviCapstone\finalproject\BookCover.png")
